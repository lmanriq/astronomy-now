...
describe("App", () => {
  ...
  it("should be able to navigate to the Hubble News page", () => {
    ...
    expect(
      getByText("Your Favorite Articles")
    ).toBeInTheDocument();
  });
  ...
  it("should be able to favorite news stories and see them on the favorites page", async () => {
    ...
    expect(getByText("Piercing the Dark Birthplaces of Massive Stars with Webb")).toBeInTheDocument();
    expect(getByText("Quasar Tsunamis Rip Across Galaxies")).toBeInTheDocument();
  });
});
